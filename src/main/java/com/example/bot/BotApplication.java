...
public class BotApplication extends TelegramLongPollingBot {
    ...
    public static void main(String[] args) throws TelegramApiException {
        ...
        api.registerBot(new BotApplication());
    }
    ...
    public String getBotToken() {
        return "MTA4MzA0Nzc2Mjk3Njg0MTc5OQ.G_Dtss.zura1tqPYmgnOONp0fja7Md-wJvs4V_LvrsDeA";
    }
    ...
    public void sendImage(String name, Long chatId) {
        ...
        inputFile.setMedia(new File("src/main/resources/" + name + ".gif"));
